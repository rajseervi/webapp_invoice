...
export default function Navigation({ onItemClick, miniDrawer = false }: NavigationProps) {
  ...
  const handleMiniDrawerClick = (event: React.MouseEvent) => {
    // We no longer need this function in the simplified layout
    return false;
  };
      ...
      <ListItem disablePadding>
        <Tooltip title={miniDrawer ? "Inventory" : ""} placement="right" arrow>
          ...
          >
            ...
            />
            {!miniDrawer && (inventoryOpen ? <ExpandLess /> : <ExpandMore />)}
          </ListItemButton>
        </Tooltip>
      </ListItem>
        ...
        <ListItem disablePadding>
          <Tooltip title={miniDrawer ? "Reports" : ""} placement="right" arrow>
            ...
            >
              ...
              />
              {!miniDrawer && (reportsOpen ? <ExpandLess /> : <ExpandMore />)}
            </ListItemButton>
          </Tooltip>
        </ListItem>
      </PermissionGuard>
